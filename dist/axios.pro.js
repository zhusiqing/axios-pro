...
var requirePromise = __webpack_require__(18);
...
var combine = function combine() {
  ...
  var baseObj = objs[0];
  var baseKeys = (0, _keys2.default)(baseObj);
  var obj = {};
  baseKeys.forEach(function (baseKey) {
    obj[baseKey] = objs.reduce(function (cur, obj) {
      return (0, _assign2.default)(cur, obj[baseKey]);
    }, {});
  });
  return obj;
};
...
var ES2015 = __webpack_require__(72);
...
var assertRecord = __webpack_require__(39);
...
var ES5 = __webpack_require__(81);
...
var toStr = Object.prototype.toString;
var hasSymbols = __webpack_require__(77)();
...
var hasSymbolSham = __webpack_require__(79);
...
var initHttpPromise = function initHttpPromise(mappers, config) {
  return (0, _keys2.default)(mappers).reduce(function (current, now) {
...
var config = __webpack_require__(148); // 倒入默认配置
var request = __webpack_require__(149);
var response = __webpack_require__(150);
...
module.exports = function (instance, config) {
  ...
  instance.interceptors.request.use(function (config) {
    ...
    if (config.handlers && config.handlers.loading && config.handlers.loading.open) {
      config.handlers && config.handlers.loading && config.handlers.loading.start && config.handlers.loading.start();
    }
    ...
    //   })
    // }
    return _promise2.default.reject(error); // 在调用的那边可以拿到(catch)你想返回的错误信息
  });
  return instance;
};
...
module.exports = function (instance, config) {
  ...
  instance.interceptors.response.use(function (response) {
    ...
    var dataType = Object.prototype.toString.call(data).replace('[object ', '').replace(']', '').toLowerCase();
    ...
    return _promise2.default.reject(err); // 返回接口返回的错误信息
  });
  return instance;
};
